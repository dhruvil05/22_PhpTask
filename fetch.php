...
if($result){
    while($data = mysqli_fetch_array($result)){
       ...
       echo  '<tr>
        ...
        <td><button type="button" data-id="'.$data['sno'].'" class="delete_record" onclick="return confirm'.('Are you sure?').'"
        style="background-color:red;">Delete</button></td>
        <td> <button type="button" data-id="'.$data['sno'].'" class="edit_record" style="background-color:green">Edit</button></td>
